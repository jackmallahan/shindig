...
app.post('/api/v1/joint_tables', (request, response) => {
  ...
  database('joint_tables').insert({ name: newPreference.prefName, categoryId: newPreference.categoryId, userId: newPreference.userId, categoryNumber: newPreference.categoryNumber }, '*')
